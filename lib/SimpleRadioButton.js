...
export default class RadioForm extends React.Component {
  ...
  static defaultProps = {
    ...
    initial: 0,
    buttonColor: '#ffffff',
    selectedButtonColor: '#00cdbe',
    formHorizontal: false,
    labelHorizontal: true,
    animation: true,
    labelColor: '#ffffff',
    selectedLabelColor: '#00cdbe',
    wrapStyle: {},
    disabled: false
  }
...
export class RadioButtonInput extends React.Component {
  ...
  render () {
    ...
    return (
      <View style={[this.props.buttonWrapStyle,{flexDirection: 'row'}]} >

        <View style={{flex:1,flexDirection: 'row',width:0.45*width,marginBottom: 30}}>
          <TouchableOpacity
              testID={this.props.testID}
              style={{justifyContent: 'center', alignItems: 'center'}}
              onPress={() => { this.props.onPress( this.props.obj.value, this.props.index) }}
          >
            <View style={{justifyContent: 'center', alignItems: 'center',width:0.25*width,}}>
              {typeof this.props.obj.price != undefined ?
              <Text style={{fontFamily: "ArialMT",justifyContent: 'center', alignItems: 'center',width:0.25*width,textAlign:'right',}}>
          ...
          <View style={{width:0.2*width,justifyContent: 'center', alignItems: 'center',}}>
            <TouchableOpacity
              accessible={this.props.accessible}
              accessibilityLabel={this.props.accessibilityLabel}
              testID={this.props.testID}
  ...
  render () {
    return (
      <TouchableWithoutFeedback
        ...
        ,{minHeight:50, borderLeftWidth: 6,borderColor:this.props.buttonColor=='#00cdbe' ? '#00cdbe' : '#ffffff',width:0.55*width,}]}>
          <Text style={[
            Style.radioLabel,
